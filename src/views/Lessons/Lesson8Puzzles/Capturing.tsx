...
class Puzzle4 extends Content {
    ...
    config(): PuzzleConfig {
        return {
            ...
            move_tree: this.makePuzzleMoveTree(
                ["f6d5f8"],
                ["d5f6", "f8f6", "f6d5e4d4", "f6d5c5e4", "g5f6", "d4f6"],
                9,
                9,
            ),
        };
...
class Puzzle8 extends Content {
    ...
    config(): PuzzleConfig {
        return {
            ...
            move_tree: this.makePuzzleMoveTree(
                ["d7e6d6e5e4"],
                ["f9e9", "h9j8f9e5", "d7e6e5d6", "d6d7", "e6d7", "d7e6e4f4e5d6"],
                9,
                9,
            ),
        };
...
export const Capturing: Array<typeof Content> = [
    Puzzle1,
    Puzzle2,
    Puzzle3,
    Puzzle4,
